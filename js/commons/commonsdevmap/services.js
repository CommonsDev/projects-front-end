...
(function() {
  ...
  GeolocationService = (function() {
    ...
    function GeolocationService($q, $rootScope, $window, options) {
      ...
      this.resolveLatLng = bind(this.resolveLatLng, this);
      this.lookupAddress = bind(this.lookupAddress, this);
      this.cancelWatchPosition = bind(this.cancelWatchPosition, this);
      this.watchPosition = bind(this.watchPosition, this);
  ...
  services.factory('debounce', [
    '$timeout', function($timeout) {
      return function(fn, timeout, apply) {
        var nthCall, ref, ref1;
        timeout = (ref = angular.isUndefined(timeout)) != null ? ref : {
          0: timeout
        };
        apply = (ref1 = angular.isUndefined(apply)) != null ? ref1 : {
          "true": apply
        };
        nthCall = 0;
        return function() {
